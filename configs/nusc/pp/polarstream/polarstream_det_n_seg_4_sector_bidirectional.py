...
if 'det' in super_tasks:
    bbox_head = dict(
        ...
        common_heads={'reg': (2, 2), 'height': (1, 2), 'dim':(3, 2), 'rot_vel':(2, 2)}, # (output_channel, num_conv)
...
test_anno = "data/nuScenes/infos_test_%02dsweeps_withvelo.pkl" %nsweeps
